...
public static class Program
{
    public static int Main(string[] args)
    {
        ...
        var cs_script = File.ReadAllText(@"..\..\Lab\2018\BuildSample.NetCore\ZipReleaseConsole\ZipHelper.cs", Encoding.UTF8);
        var ps_script = string.Format(format, cs_script);
        File.WriteAllText("KTools.ZipRelease.NetCore.ps1", ps_script, Encoding.UTF8);
